  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>{{ Lang::get('immoclick-lang.immoclick_Admin_panel') }}</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body"> 
        <p class="login-box-msg">{{ Lang::get('immoclick-lang.sign_in_title') }}</p> 
        {!!  Form::open(array('url' => '/login', 'method' => 'post','id'=>'user_login')) !!}
          @include('packages::loginpage.form') 

        {!! Form::close() !!}  
        
        <a href="{{ url('admin/forgot-password') }}">{{ Lang::get('immoclick-lang.i_forget_pwd') }}</a><br> 
    ...
    <!-- jQuery 2.1.4 -->
      ...
      <script src="{{ URL::asset('assets/plugins/iCheck/icheck.min.js') }}"></script>
       <script src="{{ URL::asset('assets/plugins/iCheck/datepicker.js') }}"></script>  
      <script>
      $(function () {
        $('input').iCheck({
