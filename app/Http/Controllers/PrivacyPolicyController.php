...
class PrivacyPolicyController extends Controller {
    ...
    public function __construct(Request $request) {
     //   $this->middleware('auth');
        View::share('viewPage', 'Politique de confidentialité');
    ...
    public function index(Request $request) {
        ...
        $page_action    = 'View Politique de confidentialité';
        ...
        return view('privacy_policy.index', compact('categories','online_since','region_id', 'rooms', 'building', 'max_price', 'min_price', 'types', 'cities', 'regions', 'reviews'));
    }
}
