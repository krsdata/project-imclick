...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="197" align="right" valign="top"><img src="http://www.immo-clic.ca/website/images/logo.png" width="197" height="61" style="display:block;"></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-bottom:10px;">
            <tr>
                <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#53231a;">
                    ...
                    <p>Bonjour,</p>
                    <br />
                    <p>les photos de votre propriété à vendre ont été ajoutées dans votre compte Immo-Clic.ca!</p> 
                    <br />
                    <p>Connectez vous à votre compte pour allez choisir et ordonner les photos que vous désirez afficher dans votre annonce!</p>
                </td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-bottom:10px;">
