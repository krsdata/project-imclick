...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ URL::asset('assets/bootstrap/css/font-awesome.min.css') }}">
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ URL::asset('assets/bootstrap/css/ionicons.min.css') }}">
    <!-- Theme style -->
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/jquery-ui.css') }}" id="theme">
