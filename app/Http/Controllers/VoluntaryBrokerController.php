...
use Hash;
/**
 * Class VoluntaryBrokerController
 */
class VoluntaryBrokerController extends Controller {
    /**
     * @var  Repository
     */
    ...
    public function __construct(Request $request) {
     //   $this->middleware('auth');
        View::share('viewPage', 'Courtier volontaire');
    ...
    public function index(Request $request) {
        ...
        $page_title     = 'Courtier volontaire'; 
        $page_action    = 'View Courtier volontaire';
        ...
        return view('voluntary_broker.index', compact('categories','online_since','region_id', 'rooms', 'building', 'max_price', 'min_price', 'types', 'cities', 'regions', 'reviews'));
    }
}
