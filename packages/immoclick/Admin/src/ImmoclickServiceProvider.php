<?php 
namespace Immoclick\Admin;

use Illuminate\Support\ServiceProvider;
use Illuminate\Routing\Router;

class ImmoclickServiceProvider extends ServiceProvider {
    ...
    {   
        ...
        if (method_exists($this, 'package')) {
            $this->package('immoclick/admin', 'immoclick/admin', __DIR__.'/..');
        } else {
            /*
             ...
             */
            $this->loadTranslationsFrom(__DIR__.'/lang', 'immoclick');

            /*
             * Assign the configuration as publishable, and tag it as 'config'
             */
            $this->publishes([
                __DIR__.'/config/config.php' => config_path('immoclick.php'),
            ], 'config');
    ...
    public function setupRoutes(Router $router)
    {
        ...
        $router->group(['namespace' => 'Immoclick\Admin\Http\Controllers'], function($router)
        {
    ...
    private function registerImmoclick()
    {
        $this->app->bind('immoclick',function($app){
            return new Immoclick($app);
        });
    }
    ...
    public function register()
    {
         ...
         */
        $this->app->bind('immoclick:install', function () {
         ...
         */
        $this->app->bind('immoclick:check-schema', function () {
         ...
         */
        $this->app->bind('immoclick:run-migrations', function () {
        ...
        $this->commands([
            'immoclick:install',
            'immoclick:check-schema',
            'immoclick:run-migrations',
        ]);
    }
