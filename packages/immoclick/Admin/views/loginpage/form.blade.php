<div class="form-group{{ $errors->first('email', ' has-error') }} has-feedback">
    {!! Form::email('email',null, ['class'=>'form-control', 'placeholder'=>Lang::get('immoclick-lang.email')]) !!}
...
<!--   <button type="submit" class="btn btn-primary btn-block btn-flat">{{ Lang::get('immoclick-lang.sign_in') }}</button> -->
    {!! Form::submit(Lang::get('immoclick-lang.sign_in'), ['class'=>'btn btn-primary btn-block btn-flat', 'id'=>'login', 'value'=>  Lang::get('immoclick-lang.sign_in') ]) !!}
</div><!-- /.col -->
</div>