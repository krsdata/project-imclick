...
<div class="col-md-6"> 
     ...
     <div class="form-group{{ $errors->first('Inclusion', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label">Inclusion</label>
        <div class="col-lg-8 col-md-8"> 
              {!! Form::Text('Inclusion',null, ['class' => 'form-control' ]) !!}
            <span class="label label-danger">{{ $errors->first('Inclusion', ':message') }}</span>
        </div>
    </div> 
