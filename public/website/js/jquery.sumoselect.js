...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var select1 = "{0} " + select;

        var settings = $.extend({
            placeholder: 'Select Here',   // Dont change it here.
            csvDispCount: 3,              // display no. of items in multiselect. 0 to display all.
            captionFormat: select1, //{{0}} Select, // format of caption text. you can set your locale.
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                multiSelelect: function () {
                    ...
                    O.okbtn = $('<p class="btnOk">Toutes</p>').click(function () {
                        var options = $(".citys-search").find(".options").find("li:not('.selected')");
                        options.click();
                    ...
                    O.cancelBtn = $('<p class="btnCancel">Aucune</p>').click(function (event) {
                        var container = $(event.currentTarget).parents(".bottom-search-box");
                        container.find(".options").find("li.selected").click();

                        if (container.hasClass("region-search")) {
                            setTimeout(function () { $('#region').trigger("change"); }, 500);
                        }
                        //O._cnbtn();
                        //O.hideOpts();
                    });
                    O.optDiv.append($('<div class="MultiControls" style="display:none;">').append(O.okbtn).append(O.cancelBtn));
                },
